...
const ProductsCard = ({ productDetails, onClick }) => {
  ...
  return (
  <motion.div layoutId={`product-${productDetails.id}`} 
  transition={{layout: { duration: 0.15 },
 type: "spring", stiffness: 320, damping: 20 }}  
  onClick={onClick} className="cursor-pointer group bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
